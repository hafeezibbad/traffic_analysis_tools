...
from core.pcap.natpmp.natpmp_requests import ExternalAddressRequest, PortMappingRequest
from core.pcap.natpmp.natpmp_response_builder import ExternalAddressResponseBuilder, PortMappingResponseBuilder
